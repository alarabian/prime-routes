...
const Privacy = () => {
  return (
    <>
      <div className="privacyContent sectionSpace">
        <div className="container-fluid">
          {/* Privacy Policy */}
          <p>
            At Travel Prime Routes, your privacy is important to us. This Privacy
          ...
          <div className="mb-4">
            ...
            <div className="d-flex">
              ...
              <p>
                ...
                type, device information, and usage patterns through cookies and
                analytics tools.
              </p>
            </div>
          </div>
          ...
          <div className="mb-4">
            ...
            <p className="mb-1">
              <i className="ti ti-square-rotated-filled text-primary me-2" /> To
              send promotional materials, newsletters, and special offers (you
          ...
          <div className="mb-4">
            <p className="mb-1">
              ...
              Service Providers: Third-party partners, such as airlines, hotels,
              and car rental companies, to fulfill your bookings.
            </p>
            <p className="mb-1">
              <i className="ti ti-square-rotated-filled text-primary me-2" />{" "}
